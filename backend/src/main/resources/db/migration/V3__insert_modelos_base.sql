...
(
  'Aviso de Sorteio de Consórcio',
  'consorcio.acesso-seguro.top',
  'Consórcio Nacional <atendimento@consorcio.acesso-seguro.top>',
  'Parabéns! Sua cota foi contemplada no sorteio deste mês',
  '<div style="font-family:sans-serif;max-width:600px;margin:auto;padding:24px;border:1px solid #e2e8f0;border-radius:8px;background:#fff"><div style="background:#0f172a;padding:16px 24px;margin:-24px -24px 24px;border-radius:6px 6px 0 0"><p style="color:#fff;font-size:13px;margin:0">🎉 Consórcio Nacional</p></div><h2 style="color:#1e293b;font-size:17px">Sua cota foi contemplada!</h2><p style="color:#475569;font-size:14px;line-height:1.6">Prezado cliente,</p><p style="color:#475569;font-size:14px;line-height:1.6">É com grande satisfação que informamos que a sua cota foi sorteada na assembleia realizada nesta semana. Para dar andamento na liberação da sua carta de crédito, é necessário confirmar seus dados cadastrais.</p><p style="color:#475569;font-size:14px">Acesse o portal do cliente pelo link abaixo para iniciar o processo:</p><a href="{{LINK_AQUI}}" style="display:inline-block;background:#0f766e;color:#fff;padding:12px 24px;text-decoration:none;border-radius:6px;font-size:14px;font-weight:600;margin:8px 0">Confirmar Dados e Liberar Crédito</a><p style="color:#94a3b8;font-size:12px;margin-top:24px;border-top:1px solid #f1f5f9;padding-top:12px">Em caso de dúvidas, nossa central de atendimento está à disposição.</p></div>',
  1
);