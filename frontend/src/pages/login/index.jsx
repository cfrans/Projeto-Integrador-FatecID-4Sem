  ...
  return (
    <AnimatedBackground>
      <section className="grid w-full max-w-5xl overflow-hidden rounded-2xl border border-slate-400/30 shadow-2xl shadow-slate-950/60 backdrop-blur-xs lg:grid-cols-[1.2fr_1fr]">
        ...
        <aside className="hidden lg:grid content-between gap-8 bg-[linear-gradient(165deg,rgba(15,23,42,0.82)_0%,rgba(15,118,110,0.5)_100%),linear-gradient(120deg,#0b1729_0%,#0e2a3c_100%)] p-7 text-slate-200">
          <div className="grid gap-4">
            <div className="flex items-center justify-center">
              <Logo className="w-100 h-100 justify-center" />
            </div>
            <CardDescription className="text-slate-300">
              <div className="mt-10 grid gap-4 rounded-xl border justify-center justify-items-center border-slate-400/25 bg-slate-900/35 p-4">
        ...
        {/* Formulário */}
        <section className="grid content-center bg-slate-50/95 p-6 sm:p-8 text-slate-900">
          {/* Logo mobile */}
          ...
          <form className="grid gap-4" onSubmit={handleSubmit}>
            <div className="grid gap-2">
              ...
              <Input className="w-full rounded-[10px] border-slate-300 bg-white px-3 py-3 text-[0.96rem] text-slate-900 focus-visible:border-teal-700 focus-visible:ring-3 focus-visible:ring-teal-400/30"
                id="email" type="email" name="email" placeholder="exemplo@nemo.com" required />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="password">Senha</Label>
              <Input className="w-full rounded-[10px] border-slate-300 bg-white px-3 py-3 text-[0.96rem] text-slate-900 focus-visible:border-teal-700 focus-visible:ring-3 focus-visible:ring-teal-400/30"
                id="password" type="password" name="password" placeholder="Digite sua senha" minLength={0} required />
            </div>
            ...
            <div className="mt-1 flex flex-wrap items-center justify-between gap-3 text-sm">
              ...
              <a className="font-bold text-teal-700 hover:underline cursor-pointer"
                onClick={(e) => { e.preventDefault(); navigate('/forgot-password'); }} aria-label="Recuperar senha">
                Esqueci minha senha
              </a>
            </div>
