...
export default function ForbiddenPage() {
  ...
  // Manda a pessoa de volta para a área do próprio perfil.
    ...
    <AnimatedBackground>
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '520px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          textAlign: 'center',
          boxShadow: '0 0 0 1px rgba(234,88,12,0.08), 0 25px 50px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.05)',
          position: 'relative',
        }}>
          ...
          <img
            ...
            style={{
              ...
              margin: '0 auto 8px',
              display: 'block',
              animation: 'nemo403Bob 3s ease-in-out infinite',
          ...
          <p style={{ fontSize: '14px', lineHeight: 1.7, color: '#94a3b8', marginBottom: '28px' }}>
            Você está conectado, mas não tem permissão para acessar esta área —
            ela é restrita a outro tipo de perfil. Vamos te levar de volta para o seu espaço.
          </p>
