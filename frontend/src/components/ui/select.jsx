    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Positioner
        ...
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-md border border-slate-200 bg-white text-slate-700 shadow-lg transition-all duration-200 ease-out data-closed:opacity-0 data-closed:scale-95 data-open:opacity-100 data-open:scale-100",
            className
          )}
          {...props}>
